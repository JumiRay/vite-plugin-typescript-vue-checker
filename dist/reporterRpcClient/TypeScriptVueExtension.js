...
const TypeScriptEmbeddedExtension_1 = require("fork-ts-checker-webpack-plugin/lib/typescript-reporter/extension/TypeScriptEmbeddedExtension");
...
function createTypeScriptVueExtension(configuration) {
    ...
    function getVueEmbeddedSource(fileName) {
        ...
        const vueSourceText = fs_1.default.readFileSync(fileName, { encoding: 'utf-8' });
        let script;
    ...
    return (0, TypeScriptEmbeddedExtension_1.createTypeScriptEmbeddedExtension)({
