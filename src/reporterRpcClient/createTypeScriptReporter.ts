...
import { FilesMatch, Reporter } from 'fork-ts-checker-webpack-plugin/lib/reporter';
import { createIssuesFromTsDiagnostics } from 'fork-ts-checker-webpack-plugin/lib/typescript-reporter/issue/TypeScriptIssueFactory';
...
import { createControlledWatchCompilerHost } from 'fork-ts-checker-webpack-plugin/lib/typescript-reporter/reporter/ControlledWatchCompilerHost';
import { createControlledWatchSolutionBuilderHost } from 'fork-ts-checker-webpack-plugin/lib/typescript-reporter/reporter/ControlledWatchSolutionBuilderHost';
import {
    ControlledTypeScriptSystem,
    createControlledTypeScriptSystem,
} from 'fork-ts-checker-webpack-plugin/lib/typescript-reporter/reporter/ControlledTypeScriptSystem';
import {
    getDependenciesFromTypeScriptConfiguration,
    getArtifactsFromTypeScriptConfiguration,
    parseTypeScriptConfiguration,
    isIncrementalCompilation,
} from 'fork-ts-checker-webpack-plugin/lib/typescript-reporter/reporter/TypeScriptConfigurationParser';
import { createPerformance } from 'fork-ts-checker-webpack-plugin/lib/profile/Performance';
import { connectTypeScriptPerformance } from 'fork-ts-checker-webpack-plugin/lib/typescript-reporter/profile/TypeScriptPerformance';
import { TypeScriptExtension } from 'fork-ts-checker-webpack-plugin/lib/typescript-reporter/extension/TypeScriptExtension';
import { createTypeScriptVueExtension } from './TypeScriptVueExtension';
